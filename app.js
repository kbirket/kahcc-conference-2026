...
const SESSIONS={
  ...
  "dinner":{time:"Thursday | 5:30-8:30pm",title:"Dinner and Member Meeting",sub:"Museum Mixer - A Social Safari",body:"<p>KAHCC takes over the Rolling Hills Zoo museum for an evening of food, fun and friends!</p><ul class='blist'><li><strong>Watering Hole:</strong> Cash bar and networking - prowl the grounds for wild new connections</li><li><strong>Museum Prowl:</strong> High-stakes scavenger hunt through the museum</li><li><strong>AI-nimal Selfie Contest:</strong> Transform your selfie into a wild animal using AI</li><li><strong>Trivia Trek:</strong> Mobile app trivia challenge - battle for Alpha of the Pack!</li><li><strong>Creation Center:</strong> Art in the Wild - paint, zootangle, or mold your spirit animal</li><li><strong>Grazing Along the Safari:</strong> Treats from Lucinda's Katering, Abilene KS</li></ul><p>Dinner featuring crowd-pleasing pasta from Martinelli's Little Italy, Salina!</p><p>KAHCC Membership Meeting during dinner - join us for updates and vote on issues driving the future of our organization.</p><p style='font-size:11px;color:#888;margin-top:8px;'>&#128652; Transportation available between Rolling Hills Zoo and area hotels following evening activities.</p>"},
  ...
  "talk20-fri":{time:"Friday | 9:00-10:15am",title:"Talk 20s: All Killer, No Filler",sub:"Multiple presenters from Kansas healthcare",body:"<ul class='blist'><li><strong>WCAG What? New Website Accessibility Guidelines</strong> - Panel Talk</li><li><strong>WCAG What? Accessible Social Media Guidelines</strong> - Panel Talk</li><li><strong>Ads for Pennies on the Dollar</strong> - Bryce Dolan, Clay County Memorial</li><li><strong>Winning Wisdom: 2025 Emeralds Best In Show</strong> - Shelly Conrady, NMC Health</li><li><strong>High Value &amp; Shelf-life: HCH Foundation Magazine</strong> - Roger Stockman, Holton Community Hospital</li><li><strong>Mission in Action: Chef Steve's Grab Good</strong> - Shannon Rogers, Smith County Memorial Hospital</li></ul>"},
...
function switchTab(name){
  ...
  if(name==="connect"){renderMyCard();renderConnections();renderWateringHole();loadAllAttendees();}
